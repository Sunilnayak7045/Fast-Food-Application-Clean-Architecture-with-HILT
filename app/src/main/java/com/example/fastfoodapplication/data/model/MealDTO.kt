package com.example.fastfoodapplication.data.model

import com.example.fastfoodapplication.domain.Meal
import com.example.fastfoodapplication.domain.MealDetails
...
//Meal Data Transfer Object -> to DomainMeal
fun MealDTO.toDomainMeal(): Meal {
    return Meal(
        //we r sure that id wont be null,
        id = this.idMeal,
        //if api response of name field is null, then use empty string
        name = this.strMeal ?: "",
...
//Meal Data Transfer Object -> to DomainMealDetails
